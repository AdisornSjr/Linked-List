...
public class Main {
    ...
    // StudentID: 0 , Name: Empty List!
    // ERROR
    // StudentID: 0 , Name: Empty List!
    // list7: head -> {5906001} -> {5906002} -> {5906003} -> {5906004} -> {5906005}
    // -> {5906006} -> null StudentID: 5906001 , Name: Matthew
    // StudentID: 5906006 , Name: Peter
    // StudentID: 0 , Name: Student Not Found!
    // list7: head -> {5906001} -> {5906002} -> {5906003} -> {5906007} -> {5906004}
    // -> {5906005} -> {5906006} -> null StudentID: 5906001 , Name: Matthew
    // list7: head -> {5906002} -> {5906003} -> {5906007} -> {5906004} -> {5906005}
    // -> {5906006} -> null
    // StudentID: 5906006 , Name: Peter
    // list7: head -> {5906002} -> {5906003} -> {5906007} -> {5906004} -> {5906005}
    // -> null
    // StudentID: 5906003 , Name: Luke
    // list7: head -> {5906002} -> {5906007} -> {5906004} -> {5906005} -> null
    // StudentID: 0 , Name: Student Not Found!
    // list7: head -> {5906002} -> {5906007} -> {5906004} -> {5906005} -> null
}
